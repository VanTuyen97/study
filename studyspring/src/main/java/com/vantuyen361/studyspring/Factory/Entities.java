...
import static com.vantuyen361.studyspring.LazyInit.Entities.NUMBER;
...
public class Entities {
    ...
    public Entities getInstance(){
        Entities entities = new Entities();
        entities.setFirstName("tuyen");
        entities.setLastName("nguyen van");
        return entities;
    }
